This project is an interactive pathfinding game where the user can set the start/end points and build obstacles to make the algorithm to find the shortest path. 
